...
New language that transpiles into yaml, but also allows for Schemas and Data-validation.

It has a strong [[cloud-native]] focus, with pre-defined schemas for all Kubernetes resources.
