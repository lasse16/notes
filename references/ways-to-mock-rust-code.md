...
A blog post about how to mock an [[http]] client for testing [[rust-lang|Rust]] code.

There are multiple methods presented, all with trade-offs.

Method 1 is a boxed trait, which is [[dependency-injection|dependency injected]] into the calling function.
This is the method I used in all [[object-oriented-programming|object-oriented programming languages]] I used so far.
