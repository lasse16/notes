...
REST is a widely used style for designing these interactions around resources and stateless requests, while [[graphQL]] lets clients query exactly the fields they need in a single request.
